...
Sea $\alpha$ el ángulo que se genera entre $a$ y $b$, utilizando la definición del producto punto tenemos,
$$|b||a|\cos\alpha -\dfrac{|b||a|\cos\alpha}{|a|^2}|a|^2  = 0 $$
$$|b||a|\cos\alpha -|b||a|\cos\alpha  = 0 $$
$$0 = 0$$
$$\blacksquare$$
\end{enumerate}
\end{solucion}
