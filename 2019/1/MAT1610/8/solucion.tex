...
\end{solucion}
\item Determine todos los puntos de la curva $x^2y + e^y = e$ cuya tangente es horizontal.
\begin{solucion}
...
\end{solucion}
\item Si $a$ y $b$ son números positivos, encuentre el máximo de la función 
$$f(x) = x^a(1-x)^b$$
en el intervalo $[0,1]$.
\begin{solucion}
