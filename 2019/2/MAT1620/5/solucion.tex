...
\begin{enumerate}[a)]
\item 
\item Es evidente que no podemos convertir la función directamente a una serie, por lo que probaremos derivandola antes.
		$$f'(x) = \dfrac{1}{1+x}$$
...
\item $\sum\limits_{n=1}^\infty \dfrac{(2x-3)^n}{n2^n}$
\end{enumerate}
\begin{solucion}
